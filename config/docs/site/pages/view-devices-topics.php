...
<div class="sub-heard-part">
	<ol class="breadcrumb m-b-0">
		<li><a class="device-manufacturer-name" href="index.php?pageActive=devices&device_type={type}&device_manufacturer={manufacturer}">manufacturer_name</a></li>
		<li class="active device-name">name</li>
	</ol>
</div>

<div class="inner-bg device-topics-page-view">
	<div class="container">
		<div class="row">
			<div class="col-sm-5 phone wow fadeInLeft animated text-center" style="visibility: visible; animation-name: fadeInLeft;">
				<img style="display: inline;" class="img-responsive iamgurdeeposahan zoomImage" src=""> <!-- max-width:{['size']->maxWidth}; -->
			</div>
